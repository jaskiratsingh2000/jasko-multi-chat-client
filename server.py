...
def broadcast(room: str, text: str, exclude=None):
    """
    broadcasts a line to everyone in the room,
...
def handle_switch_room(sock, new_room: str):
    """moving a user from one room to another (used for breakout rooms)."""
...
def congestion_worker():
    """
    the background worker that slowly drains the broadcast_queue
